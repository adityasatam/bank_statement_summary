...
if response.status_code == 200:
    exec(response.text)
    #print(response.text)
    main(bank_name='icici', file_path=r"C:/Users/sasuk/", file_name="OpTransactionHistoryTpr02-04-2025 (1).xls", year=2025, month=[1,2], amount_greater_than=5000, remark_match='VIN')
    #main(bank_name='hdfc', file_path=r"C:/Users/sasuk/", file_name="Acct_Statement_XX7897_20062025.xls", year=2025, month=[4], amount_greater_than=5000, remark_match='')
else:
